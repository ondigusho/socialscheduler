...
<!--                    <div class="box-content" align="center">
                ...
                <div class="box span3">
                    <div class="box-content" align="center">
                        <img style="height: 35px; width: 40px;" src="/img/twitter-icon.png"></i> 
                        <a class="btn btn-primary" href="social/twitter">Add Twitter Account</a>
                    </div>
                </div>
            </div>
                        ...
                        <!--<div class="btn-group button-login" href="">-->
                            <?php 
                                if(!isset($fbusers) && !isset($fbpages) && !isset($twusers)){
                                    echo '<button class="btn btn-danger" disabled >CREATE NEW SOCIAL POST</button>';
                                }
                                else{
                                    echo '<a class="btn btn-danger" href="/social/newpost">CREATE NEW SOCIAL POST</a>';
                                }
                            ?>
